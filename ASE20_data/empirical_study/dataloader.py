...
def load_empirical_study_data():

    empirical_study_project_files = {
        p: f
        for p, f in data_files.items() if p in empirical_study_projects
    }
    return get_dataset(empirical_study_project_files, is_scale=False)
