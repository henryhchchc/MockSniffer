...
fun findSrcDir(rootDirectory: File) =
    findCodeDir(
        rootDirectory,
        srcDirs,
    )

fun findTestSrcDir(rootDirectory: File) =
    findCodeDir(
        rootDirectory,
        testSrcDirs,
    )

fun findBinDir(rootDirectory: File) =
    findCodeDir(
        rootDirectory,
        binDirs,
    )

fun findTestBinDir(rootDirectory: File) =
    findCodeDir(
        rootDirectory,
        testBinDirs,
    )
